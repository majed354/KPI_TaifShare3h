...
headers_ar = [
    ...
    'جدد السنة السابقة', 'جدد قبل 4 سنوات',
...
formulas = [
    ('نسبة التخرج في الوقت المحدد', 'خريجون في الوقت ÷ عدد الطلاب الجدد قبل 4 سنوات × 100'),
    ...
    ('ملاحظة', 'السنة 1443 غير موجودة (مدمجة مع 1442)، السنة 1438 سنة أساس فقط'),
]
